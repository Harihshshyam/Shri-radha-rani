...
class NewsPanda_Jumbo_Widget extends NewsPanda_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'newspanda-widget-jumbo-post';
        $this->widget_description = __("Jumbo Widget transforms your posts into a visually appealing mosaic, creating a stylish and organized showcase for an immersive reader experience.", 'newspanda');
        $this->widget_id = 'NewsPanda_Jumbo_Widget';
        $this->widget_name = __('NewsPanda: Jumbo Post', 'newspanda');
    ...
    protected function get_widget_settings()
    {
        return array(
            ...
            'layout_style' => array(
                ...
                'options' => array(
                    'jumbo-layout-1' => __('Layout 1', 'newspanda'),
                    'jumbo-layout-2' => __('Layout 2', 'newspanda'),
                    'jumbo-layout-3' => __('Layout 3', 'newspanda'),
                ),
                'std' => 'jumbo-layout-1',
            ),
            'offset' => array(
    ...
    public function get_posts($args, $instance)
    {
        ...
        return new WP_Query(apply_filters('NewsPanda_Jumbo_Widget_query_args', $query_args));
    }
    ...
    public function widget($args, $instance)
    {
        ...
        do_action('newspanda_before_jumbo_widget');
        $counter = 1;
                                        ...
                                        <?php if (!empty($instance['show_date']) && $instance['show_date']) : ?>
                                            <div class="entry-meta entry-date posted-on">
                                                ...
                                                echo ('format_1' === $date_format) ?
                                                    esc_html(human_time_diff(get_the_time('U'), current_time('timestamp')) . ' ' . __('ago', 'newspanda')) :
        ...
        do_action('newspanda_after_jumbo_widget');
        ob_end_flush();
    }
}