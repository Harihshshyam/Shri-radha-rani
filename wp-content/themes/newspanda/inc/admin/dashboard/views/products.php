<div class="newspanda-dashboard-content products-page">
    <div class="dashboard-content-panel">
        <div class="postbox newspanda-quick-settings">
            <div class="postbox-header">
            <h2 class="hndle ui-sortable-handle">
                <?php esc_html_e('Themes', 'newspanda'); ?>
            </h2>
            </div>
            <div class="inside inside__themes">
                ...
                $themes_data = array(
                    'newsarc' => array(
                        'name' => 'NewsArc',
                        'slug' => 'newsarc',
                        'image' => NEWSPANDA_PARENT_URL . '/inc/admin/dashboard/images/newsarc.webp',
                    ...
                    'newsmarks' => array(
                        'name' => 'NewsMarks',
                        'slug' => 'newsmarks',
                        'image' => NEWSPANDA_PARENT_URL . '/inc/admin/dashboard/images/newsmarks.webp',
                    ...
                    'newsmass' => array(
                        'name' => 'NewsMass',
                        'slug' => 'newsmass',
                        'image' => NEWSPANDA_PARENT_URL . '/inc/admin/dashboard/images/newsmass.webp',
                    ...
                    'blogmarks' => array(
                        'name' => 'BlogMarks',
                        'slug' => 'blogmarks',
                        'image' => NEWSPANDA_PARENT_URL . '/inc/admin/dashboard/images/blogmarks.webp',
                        ...
                        <div class="cta">
                            <div class="cta-text">
                                <a href="<?php echo esc_url($theme_info['learn_more_link']); ?>"
                                   target="_blank"><?php esc_html_e('Learn More', 'newspanda'); ?></a>
                                <a href="<?php echo esc_url($theme_info['live_demo_link']); ?>"
                                   target="_blank"><?php esc_html_e('Live demo', 'newspanda'); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
        ...
        <div class="postbox newspanda-quick-settings">
            <div class="postbox-header">
            <h2 class="hndle ui-sortable-handle">
                <?php esc_html_e('Plugins', 'newspanda'); ?>
            </h2>
            </div>
            <div class="inside inside__plugins">
                ...
                $plugins_data = array(
                    ...
                    'elementor' => array(
                        ...
                        'slug' => 'elementor',
                        'image' => NEWSPANDA_PARENT_URL . '/inc/admin/dashboard/images/elementor-banner.webp',
                    ...
                    'one-click-demo-import' => array(
                        ...
                        'image' => NEWSPANDA_PARENT_URL . '/inc/admin/dashboard/images/ocdi.webp',
                    ...
                    'mailchimp-for-wp' => array(
                        ...
                        'image' => NEWSPANDA_PARENT_URL . '/inc/admin/dashboard/images/mc4wp.webp',
                        ...
                        <div class="cta">
                            <div class="cta-text">
                                ...
                                <a href="<?php echo $plugin_info['live_demo_link']; ?>"
                                   target="_blank"><?php esc_html_e('Plugin Page', 'newspanda'); ?></a>
                            </div>
                            <div class="cta-button">
                                <?php if ($is_plugin_installed) : ?>
                                    <?php if ($is_plugin_activated) : ?>
                                        <span class="activated"><?php esc_html_e('Activated', 'newspanda'); ?></span>
                                    <?php else : ?>
                                        <a href="#" class="button button-primary dashboard-button dashboard-button-primary activate-plugin" data-plugin="<?php echo $plugin_file; ?>" data-slug="<?php echo $plugin_slug; ?> "><?php esc_html_e('Activate', 'newspanda'); ?></a>
                                    <?php endif; ?>
                                <?php else : ?>
                                    <a href="#" class="button button-secondary dashboard-button dashboard-button-secondary install-plugin" data-plugin="<?php echo $plugin_file; ?>" data-slug="<?php echo $plugin_slug; ?> "><?php esc_html_e('Install', 'newspanda'); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
