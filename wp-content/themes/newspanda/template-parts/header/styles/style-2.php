...
if ($enable_header_advertisement && !empty($header_advert_image)) { ?>
...
<header id="masthead" class="site-header site-header-2 <?php echo has_header_image() ? 'has-header-image data-bg' : ''; ?>" <?php if (has_header_image()) { ?>data-background="<?php echo esc_url(get_header_image()); ?>" <?php } ?> >
