<?php
/**
 * NewsPanda Elementor Widget Block 2.
 *
 * @package    NewsPanda
 ...
 * NewsPanda Elementor Widget Block 2.
 *
 * Class NewsPanda_Elementor_Widgets_Block_2
 */
class NewsPanda_Elementor_Widgets_Block_2 extends NewsPanda_Elementor_Widget_Base
{
    /**
     * Post number.
     *
    ...
    /**
     * Retrieve NewsPanda_Elementor_Widgets_Block_2 widget name.
     *
     * @access public
    ...
    {
        return 'NewsPanda-Posts-Block-2';
    }

    /**
     * Retrieve NewsPanda_Elementor_Widgets_Block_2 widget title.
     *
     * @access public
    ...
    {
        return esc_html__('Block Style 2', 'newspanda');
    }

    /**
     * Retrieve NewsPanda_Elementor_Widgets_Block_2 widget icon.
     *
     * @access public
    ...
    {
        return 'newspanda-econs-block-2';
    }

    /**
     * Retrieve the list of categories the NewsPanda_Elementor_Widgets_Block_2 widget belongs to.
     *
     * @access public
    ...
    public function widget_title_font_controls() {
        $this->add_responsive_control(
            'title_font_size',
            [
                'label' => esc_html__( 'Title Font Size', 'newspanda' ) . ' (px)',
    ...
    /**
     * Render NewsPanda_Elementor_Widgets_Block_2 widget output on the frontend.
     *
     * @access protected
     */
    protected function render()
    {
        ...
        <div class="newspanda-module-block newspanda-module-block-style-2 newspanda-element-wrapper wrapper-gutter-medium">
            <?php
