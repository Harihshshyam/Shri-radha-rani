<?php
/**
 * NewsPanda Elementor Widget Grid 4.
 *
 * @package    NewsPanda
 ...
 * NewsPanda Elementor Widget Grid 4.
 *
 * Class NewsPanda_Elementor_Widgets_Grid_4
 */
class NewsPanda_Elementor_Widgets_Grid_4 extends NewsPanda_Elementor_Widget_Base
{
    ...
    /**
     * Retrieve NewsPanda_Elementor_Widgets_Grid_4 widget name.
     *
     * @access public
     *
    ...
    {
        return 'NewsPanda-Posts-Grid-4';
    }

    /**
     * Retrieve NewsPanda_Elementor_Widgets_Grid_4 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Grid Style 4', 'newspanda');
    }

    /**
     * Retrieve NewsPanda_Elementor_Widgets_Grid_4 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'newspanda-econs-grid-4';
    }

    /**
     * Retrieve the list of categories the NewsPanda_Elementor_Widgets_Grid_4 widget belongs to.
     *
    ...
    /**
     * Render NewsPanda_Elementor_Widgets_Grid_4 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="newspanda-module-grid newspanda-module-grid-style-4 newspanda-element-wrapper wrapper-gutter-small">
            <?php
            ...
            <div class="row-group">
                ...
                while ($get_featured_posts->have_posts()) :
                    ...
                    <div class="elementor-custom-column">
                        <article id="module-grid-4-<?php the_ID(); ?>" <?php post_class('wpi-post-module-grid wpi-post wpi-tile-post'); ?>>
