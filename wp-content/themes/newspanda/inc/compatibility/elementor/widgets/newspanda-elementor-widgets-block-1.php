<?php
/**
 * NewsPanda Elementor Widget Block 1.
 *
 * @package    NewsPanda
 ...
 * NewsPanda Elementor Widget Block 1.
 *
 * Class NewsPanda_Elementor_Widgets_Block_1
 */
class NewsPanda_Elementor_Widgets_Block_1 extends NewsPanda_Elementor_Widget_Base
{

    /**
     * Retrieve NewsPanda_Elementor_Widgets_Block_1 widget name.
     *
     * @access public
     *
    ...
    {
        return 'NewsPanda-Posts-Block-1';
    }

    /**
     * Retrieve NewsPanda_Elementor_Widgets_Block_1 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Block Style 1', 'newspanda');
    }

    /**
     * Retrieve NewsPanda_Elementor_Widgets_Block_1 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'newspanda-econs-block-1';
    }

    /**
     * Retrieve the list of categories the NewsPanda_Elementor_Widgets_Block_1 widget belongs to.
     *
    ...
    public function widget_title_font_controls() {
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Title Font Size Left Column', 'newspanda' ) . ' (px)',
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Title Font Size Right Column', 'newspanda' ) . ' (px)',
                'type' => Controls_Manager::NUMBER,
                'placeholder' => 20,
                'selectors' => [
                    '{{WRAPPER}} h3.elementor-entry-title.entry-title.entry-title-medium ' => 'font-size: {{VALUE}}px', //Need the full path for exclude the inner section
    ...
    /**
     * Render NewsPanda_Elementor_Widgets_Block_1 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="newspanda-module-block newspanda-module-block-style-1 newspanda-element-wrapper wrapper-gutter-medium">
            <?php
