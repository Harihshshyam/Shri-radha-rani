<?php
/**
 * NewsPanda Elementor Widget Grid 5.
 *
 * @package    NewsPanda
 ...
 * NewsPanda Elementor Widget Grid 5.
 *
 * Class NewsPanda_Elementor_Widgets_Grid_5
 */
class NewsPanda_Elementor_Widgets_Grid_5 extends NewsPanda_Elementor_Widget_Base
{
    ...
    /**
     * Retrieve NewsPanda_Elementor_Widgets_Grid_5 widget name.
     *
     * @access public
     *
    ...
    {
        return 'NewsPanda-Posts-Grid-5';
    }

    /**
     * Retrieve NewsPanda_Elementor_Widgets_Grid_5 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Grid Style 5', 'newspanda');
    }

    /**
     * Retrieve NewsPanda_Elementor_Widgets_Grid_5 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'newspanda-econs-grid-5';
    }

    /**
     * Retrieve the list of categories the NewsPanda_Elementor_Widgets_Grid_5 widget belongs to.
     *
    ...
    /**
     * Render NewsPanda_Elementor_Widgets_Grid_5 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="newspanda-module-grid newspanda-module-grid-style-5 newspanda-element-wrapper wrapper-gutter-small">
            <?php
            ...
            <div class="row-group">
                ...
                while ($get_featured_posts->have_posts()) :
                    ...
                    <div class="elementor-custom-column">
                        <article id="module-grid-5-<?php the_ID(); ?>" <?php post_class('wpi-post-module-grid wpi-post wpi-tile-post'); ?>>

                            <?php if (has_post_thumbnail()) : ?>
                                <div class="elementor-entry-image entry-image image-hover-effect hover-effect-shine entry-image-medium">
                                    <?php
