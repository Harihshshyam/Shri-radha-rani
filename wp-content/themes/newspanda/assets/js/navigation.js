...
// event "polyfill"
newspanda.createEvent = function (eventName) {
    var event;
    ...
    hideAndShowModals: function () {
        ...
        modals.forEach(function (modal) {
            modal.addEventListener('toggle-target-before-inactive', function (event) {
                ...
                _win.newspanda.scrolled = parseInt(styles.top, 10);
                if (adminBar) {
            ...
            modal.addEventListener('toggle-target-after-inactive', function (event) {
                ...
                setTimeout(function () {
                    var clickedEl = newspanda.toggles.clickedEl;
                    ...
                    _win.scrollTo(0, Math.abs(_win.newspanda.scrolled + getAdminBarHeight()));
                    _win.newspanda.scrolled = 0;
                }, 500);
            });
        });
    },
...
newspanda.modalMenu = {
    ...
    expandLevel: function () {
        ...
        modalMenus.forEach(function (modalMenu) {
            ...
            if (activeMenuItem) {
                newspandaFindParents(activeMenuItem, 'li').forEach(function (element) {
                    var subMenuToggle = element.querySelector('.sub-menu-toggle');
                    if (subMenuToggle) {
                        newspanda.toggles.performToggle(subMenuToggle, true);
                    }
                });
            }
        });
    ...
    keepFocusInModal: function () {
        ...
        _doc.addEventListener('keydown', function (event) {
            var toggleTarget, modal, selectors, elements, menuType, bottomMenu, activeEl, lastEl, firstEl, tabKey,
                shiftKey, clickedEl = newspanda.toggles.clickedEl;
...
newspanda.toggles = {
    ...
    performToggle: function (element, instantly) {
        ...
        if (target.classList.contains(activeClass)) {
            target.dispatchEvent(newspanda.createEvent('toggle-target-before-active'));
        } else {
            target.dispatchEvent(newspanda.createEvent('toggle-target-before-inactive'));
        }
        ...
        setTimeout(function () {
            ...
            if (toggle.dataset.toggleType === 'slidetoggle' && !instantly && duration !== '0') {
                newspandaMenuToggle(newTarget, duration);
            } else {
            ...
            newspandaToggleAttribute(toggle, 'aria-expanded', 'true', 'false');
            if (self.clickedEl && -1 !== toggle.getAttribute('class').indexOf('close-')) {
                newspandaToggleAttribute(self.clickedEl, 'aria-expanded', 'true', 'false');
            }
            // Toggle body class.
            ...
            target.dispatchEvent(newspanda.createEvent('toggled'));
            // Trigger events on the toggle targets after they are toggled.
            if (target.classList.contains(activeClass)) {
                target.dispatchEvent(newspanda.createEvent('toggle-target-after-active'));
            } else {
                target.dispatchEvent(newspanda.createEvent('toggle-target-after-inactive'));
            }
        }, timeOutTime);
    },
    // Do the toggle.
...
newspandaDomReady(function () {
    newspanda.toggles.init();              // Handle toggles.
    newspanda.coverModals.init();          // Handle cover modals.
    newspanda.modalMenu.init();            // Modal Menu.
    newspanda.primaryMenu.init();          // Primary Menu.
    newspanda.touchEnabled.init();         // Add class to body if device is touch-enabled.
});
/*	-----------------------------------------------------------------------------------------------
	Helper functions
--------------------------------------------------------------------------------------------------- */
...
/* Toggle an attribute ----------------------- */
function newspandaToggleAttribute(element, attribute, trueVal, falseVal) {
    var toggles;
 ...
 */
function newspandaMenuToggle(target, duration) {
 ...
 */
function newspandaFindParents(target, query) {
    var parents = [];
