<?php
/**
 * NewsPanda Elementor Widget Block 5.
 *
 * @package    NewsPanda
 ...
 * NewsPanda Elementor Widget Block 5.
 *
 * Class NewsPanda_Elementor_Widgets_Block_5
 */
class NewsPanda_Elementor_Widgets_Block_5 extends NewsPanda_Elementor_Widget_Base
{
    ...
    /**
     * Retrieve NewsPanda_Elementor_Widgets_Block_5 widget name.
     *
     * @access public
     *
    ...
    {
        return 'NewsPanda-Posts-Block-5';
    }

    /**
     * Retrieve NewsPanda_Elementor_Widgets_Block_5 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Block Style 5', 'newspanda');
    }

    /**
     * Retrieve NewsPanda_Elementor_Widgets_Block_5 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'newspanda-econs-block-5';
    }

    /**
     * Retrieve the list of categories the NewsPanda_Elementor_Widgets_Block_5 widget belongs to.
     *
    ...
    /**
     * Render NewsPanda_Elementor_Widgets_Block_5 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="newspanda-module-block newspanda-module-block-style-5 newspanda-element-wrapper wrapper-gutter-medium">
            <?php
