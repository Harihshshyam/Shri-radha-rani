...
class NewsPanda_Slider_Posts extends NewsPanda_Widget_Base
{
    public function __construct()
    {
        $this->widget_cssclass = 'newspanda-slider-widget';
        $this->widget_description = __("Displays recent posts in a slider with an image", 'newspanda');
        $this->widget_id = 'newspanda_slider_posts';
        $this->widget_name = __('NewsPanda: Slider Posts', 'newspanda');
    ...
    protected function get_posts($args, $instance)
    {
        ...
        return new WP_Query(apply_filters('newspanda_slider_posts_query_args', $query_args));
    }
    /**
    ...
    public function widget($args, $instance)
    {
        ...
        do_action('newspanda_before_slider_posts_with_image');
        ...
        <?php
        do_action('newspanda_after_slider_posts_with_image');
