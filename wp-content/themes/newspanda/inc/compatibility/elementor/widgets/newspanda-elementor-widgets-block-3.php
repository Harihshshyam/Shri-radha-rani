<?php
/**
 * NewsPanda Elementor Widget Block 3.
 *
 * @package    NewsPanda
...
/**
 * Class NewsPanda_Elementor_Widgets_Block_3
 */
class NewsPanda_Elementor_Widgets_Block_3 extends NewsPanda_Elementor_Widget_Base
{
    ...
    /**
     * Retrieve NewsPanda_Elementor_Widgets_Block_3 widget name.
     *
     * @access public
     *
    ...
    {
        return 'NewsPanda-Posts-Block-3';
    }

    /**
     * Retrieve NewsPanda_Elementor_Widgets_Block_3 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Block Style 3', 'newspanda');
    }

    /**
     * Retrieve NewsPanda_Elementor_Widgets_Block_3 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'newspanda-econs-block-3';
    }

    /**
     * Retrieve the list of categories the NewsPanda_Elementor_Widgets_Block_3 widget belongs to.
     *
    ...
    /**
     * Render NewsPanda_Elementor_Widgets_Block_3 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="newspanda-module-block newspanda-module-block-style-3 newspanda-element-wrapper wrapper-gutter-medium">
            <?php
