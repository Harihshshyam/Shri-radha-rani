<?php
/**
 * NewsPanda Elementor Widget Grid 1.
 *
 * @package    NewsPanda
 ...
 * NewsPanda Elementor Widget Grid 1.
 *
 * Class NewsPanda_Elementor_Widgets_Grid_1
 */
class NewsPanda_Elementor_Widgets_Grid_1 extends NewsPanda_Elementor_Widget_Base
{
    /**
     * Retrieve NewsPanda_Elementor_Widgets_Grid_1 widget name.
     *
     * @access public
     *
    ...
    {
        return 'NewsPanda-Posts-Grid-1';
    }
    /**
     * Retrieve NewsPanda_Elementor_Widgets_Grid_1 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Grid Style 1', 'newspanda');
    }
    /**
     * Retrieve NewsPanda_Elementor_Widgets_Grid_1 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'newspanda-econs-grid-1';
    }
    /**
     * Retrieve the list of categories the NewsPanda_Elementor_Widgets_Grid_1 widget belongs to.
     *
    ...
    /**
     * Render NewsPanda_Elementor_Widgets_Grid_1 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        ?>
        <div class="newspanda-module-grid newspanda-module-grid-style-1 newspanda-element-wrapper wrapper-gutter-small">
            <?php
            ...
            <div class="row-group">
                ...
                while ($get_featured_posts->have_posts()) :
                    ...
                    $main_wrapper_class = (1 === $count) ? 'wpi-post-module-grid wpi-post wpi-tile-post newspanda-module-grid--full elementor-custom-column' : 'wpi-post-module-grid wpi-post wpi-tile-post newspanda-module-grid--quarter elementor-custom-column';
                    ?>
