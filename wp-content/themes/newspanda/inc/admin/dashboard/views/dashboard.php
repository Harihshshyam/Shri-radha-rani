...
function import_button_html()
{
    ...
    if (file_exists(WP_PLUGIN_DIR . '/mailchimp-for-wp/mailchimp-for-wp.php') && is_plugin_inactive('mailchimp-for-wp/mailchimp-for-wp.php')) {
        $newspanda_btn_texts = __('Activate WpInterface Add-Ons', 'newspanda');
    ...
    elseif (!file_exists(WP_PLUGIN_DIR . '/wpinterface-add-ons/wpinterface-add-ons.php')&& is_plugin_inactive('wpinterface-add-ons/wpinterface-add-ons.php')) {
        $newspanda_btn_texts = __('Install WpInterface Add-Ons', 'newspanda');
        $button_url = $admin_url . 'plugin-install.php?s=wpinterface-add-ons&tab=search&type=term';
    }
    // Default to view starter templates
    else {
        $newspanda_btn_texts = __('View Starter Templates', 'newspanda');
        $button_url = '#'; // Replace with the actual URL for viewing starter templates
    }

    $html = '<a class="btn-get-started" href="' . esc_url($button_url) . '" data-name="' . esc_attr('mailchimp-for-wp') . '" data-slug="' . esc_attr('mailchimp-for-wp') . '" aria-label="' . esc_attr($newspanda_btn_texts) . '">' . esc_html($newspanda_btn_texts) . '</a>';
    return $html;
}

?>
    <div class="newspanda-dashboard-content">
        <div class="dashboard-content-panel content-panel-upper">
            <div class="postbox">
                <div class="inside newspanda-dashboard-welcome">
                    <div class="newspanda-notice-left">
                        <h2 class="newspanda-notice-heading">
                            <?php
                            printf(
                                esc_html__('Start Building with NewsPanda!', 'newspanda')
                            );
                            ?>
                        </h2>
                        <p>
                            <?php esc_html_e('Experience effortless magazine-themed website creation with NewsPanda! Explore all the settings and features here.', 'newspanda'); ?>
                        </p>
                        ...
                        <div class="dashboard-button-group">
                            ...
                            <a href="<?php echo esc_url($this->preview_url); ?>"
                               ...
                               target="_blank">
                                <?php esc_html_e('Live Preview', 'newspanda'); ?>
                            </a>

                        </div>

                    </div>
                    <div class="newspanda-notice-right">
                        <div class="newspanda-intro-image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="dashboard-content-panel content-panel-lower">
            <div class="dashboard-content-left">
                <div class="postbox newspanda-quick-settings">
                    <div class="postbox-header">
                        <h2 class="hndle ui-sortable-handle"><?php esc_html_e('Quick Settings', 'newspanda'); ?></h2>
                        <a href="<?php echo esc_url(' ' . $admin_url . 'customize.php?'); ?>"
                           class="hndle-controller newspanda-link" target="_blank">
                            <?php echo 'Visit Customizer' . $link_icon; ?>
                        </a>
                    </div>
                    <div class="inside newspanda-available-settings">
                        <?php
                        // Array of settings items
                        $settings_items = array(
                            array(
                                'title' => esc_html__('Site Identity', 'newspanda'),
                                'type' => 'section',
                                'id' => 'title_tagline',
                            ),
                            array(
                                'title' => esc_html__('Header Options', 'newspanda'),
                                'type' => 'panel',
                                'id' => 'header_options_panel',
                            ),
                            array(
                                'title' => esc_html__('Footer Options', 'newspanda'),
                                'type' => 'panel',
                            ...
                            array(
                                'title' => esc_html__('Single Options', 'newspanda'),
                                'type' => 'panel',
                ...
                <div class="postbox newspanda-premium-settings">
                    <div class="postbox-header">
                        <h2 class="hndle ui-sortable-handle"><?php esc_html_e('Premium Features', 'newspanda'); ?></h2>
                        <?php if (!$this->pro_status) { ?>
                            <a href="<?php echo esc_url($this->theme_url); ?>#choose-pricing-plan"
                               class="hndle-controller newspanda-link" target="_blank">
                    ...
                    <div class="inside newspanda-unavailable-settings">
                        ...
                        foreach ($premium_features_items as $item) {
                            ?>
                            <div class="newspanda-features-list newspanda-premium-features">
                                ...
                                <div class="item-content-right">
                                    <img class="newspanda-premium-badge"
                                         src="<?php echo esc_url(NEWSPANDA_PARENT_URL . '/inc/admin/dashboard/images/badge.webp'); ?>"
                                         alt="<?php esc_attr_e('NewsPanda', 'newspanda'); ?>">
                                </div>
                            </div>
                            <?php
                        }
            ...
            <div class="dashboard-content-right">
                <div class="postbox newspanda-postbox-documentation">
                    <div class="postbox-header">
                    ...
                    <div class="inside">
                        <p>
                            <?php
                            echo esc_html__('Encountering an issue? Our comprehensive and detailed documentation is designed to address your concerns and provide clear, thorough explanations to resolve any confusion.', 'newspanda');
                            ?>
                        </p>
                        <a href="<?php echo esc_url($this->doc_url); ?>"
                           target="_blank"><?php esc_html_e('Documentation', 'newspanda'); ?></a>
                    </div>
                </div>
                <div class="postbox newspanda-postbox-review">
                    <div class="postbox-header">
                        <h3 class="hndle ui-sortable-handle">
                            <?php esc_html_e('Leave us a Review', 'newspanda'); ?>
                        </h3>
                        <div class="hndle-controller">
                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20"
                                 fill="none">
                    ...
                    <div class="inside">
                        ...
                        <div><?php esc_html_e('Based on 20+ Reviews', 'newspanda'); ?></div>
                        <p>
                            <?php
                            echo sprintf(
                            /* translators: %s: Theme Name. */
                                esc_html__('What do you think of our theme? Was it a good experience and did it match your expectations? Let us know so we can improve!', 'newspanda'),
                                $theme->Name
                            );
                            ?>
                        </p>
                        <a href="<?php echo esc_url('https://wordpress.org/support/theme/newspanda/reviews/?rate=5#new-post'); ?>"
                           target="_blank"><?php esc_html_e('Submit a Review', 'newspanda'); ?></a>
                    </div>
                </div>

                <div class="postbox newspanda-postbox-support">
                    <div class="postbox-header">
                        <h3 class="hndle ui-sortable-handle">
                            <?php esc_html_e('Support', 'newspanda'); ?>
                        </h3>
                        <div class="hndle-controller">
                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20"
                                 fill="none">
                    ...
                    <div class="inside">
                        ...
                        <?php if (!$this->pro_status) { ?>
                            ...
                            <a href="<?php echo esc_url($this->community_url); ?>" target="_blank">
                                <?php esc_html_e('Community Support', 'newspanda'); ?>
                            </a>
                        <?php } else { ?>
                            <p>
                                <?php
                                echo sprintf(
                                /* translators: %s: Theme Name. */
                                    esc_html__('Need assistance? Reach out to our professional support team by submitting a support ticket, and we\'ll provide you with the help you need.', 'newspanda')
                                );
                                ?>
                            </p>
                            <a href="<?php echo esc_url($this->support_url); ?>" target="_blank">
                                <?php esc_html_e('Create a Ticket', 'newspanda'); ?>
                            </a>
                        <?php } ?>

                    </div>
                </div>
                <div class="postbox newspanda-postbox-plugins">
                    <div class="postbox-header">
                        <h3 class="hndle">
                            <?php esc_html_e('Useful Plugins', 'newspanda'); ?>
                        </h3>
                        <div class="hndle-controller">
                    ...
                    <div class="inside">
                        ...
                        $plugins = array(
                            array(
                                ...
                                'color' => '#5317AA',
                                'image' => NEWSPANDA_PARENT_URL . '/inc/admin/dashboard/images/ocdi-256x256.webp',
                            ...
                            array(
                                ...
                                'color' => '#5317AA',
                                'image' => NEWSPANDA_PARENT_URL . '/inc/admin/dashboard/images/addons-256x256.webp',
                        ...
                        foreach ($plugins as $plugin) {
                            ...
                            $is_plugin_installed = newspanda_is_plugin_installed($plugin_file);
                            ...
                            <div class="postbox-recommended-plugin">
                                ...
                                <?php if ($is_plugin_installed) : ?>
                                    <?php if ($is_plugin_activated) : ?>
                                        <div class="recommended-plugin-action"><?php esc_html_e('Activated', 'newspanda'); ?></div>
                                    <?php else : ?>
                                        <div class="recommended-plugin-action">
                                            <a href="#" class="activate-plugin"
                                               ...
                                               data-slug="<?php echo esc_attr($plugin_slug); ?> ">
                                                <?php esc_html_e('Activate', 'newspanda'); ?>
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                <?php else : ?>
                                    <div class="recommended-plugin-action">
                                        <a href="#" class="install-plugin"
                                           data-plugin="<?php echo esc_attr($plugin_file); ?>"
                                           data-slug="<?php echo esc_attr($plugin_slug); ?> ">
                                            <?php esc_html_e('Install', 'newspanda'); ?>
                                        </a>
                                    </div>
                                <?php endif; ?>
                            </div>
                ...
                <div class="postbox newspanda-postbox-facebook">
                    <div class="postbox-header">
                        <h3 class="hndle">
                            <?php esc_html_e('Facebook Community', 'newspanda'); ?>
                        </h3>
                        <div class="hndle-controller">
                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20"
                                 fill="none">
                    ...
                    <div class="inside">
                        <p>
                            <?php echo esc_html__('Join our Facebook page to connect with like-minded individuals for discussions, help, and support on all things related to the theme!', 'newspanda'); ?>
                        </p>
                        <a href="<?php echo esc_url($this->facebook_url); ?>"
                           target="_blank"><?php esc_html_e('Like or follow our Facebook Page', 'newspanda'); ?></a>
                    </div>
                </div>
            </div>
        </div>
    </div><!--/.newspanda-dashboard-content-->
<?php
